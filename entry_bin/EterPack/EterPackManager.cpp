...
const time_t g_tCachingInterval = 10; // 10ĂĘ
...
bool CEterPackManager::GetFromFile(CMappedFile & rMappedFile, const char * c_szFileName, LPCVOID * pData)
{
	...
	//if (pcExt && 
	//	_strnicmp(pcExt, ".py", 3) == 0 && // python ˝şĹ©¸łĆ® Áß
	//	stricmp(c_szFileName, "logininfo.py") != 0 && // ·Î±×ŔÎ Á¤ş¸ ĆÄŔĎŔĚ ľĆ´Ď°í
