...
class CSkyObjectQuad
{
	public:
		CSkyObjectQuad();
		void Clear(uint8_t c_rucNumVertex, float c_rfRed, float c_rfGreen, float c_rfBlue, float c_rfAlpha);
		void SetSrcColor(uint8_t c_rucNumVertex, float c_rfRed, float c_rfGreen, float c_rfBlue, float c_rfAlpha);
		void SetTransition(uint8_t c_rucNumVertex, float c_rfRed, float c_rfGreen, float c_rfBlue, float c_rfAlpha, uint32_t dwDuration);
