...
{
	printf("CItemManager::LoadItemTable: Rozpoczêto ³adowanie %s", c_szFileName);
	...
	{
		printf("CItemManager::LoadItemTable: Przetwarzanie elementu %d z %s /n", i + 1, c_szFileName);
	...
	printf("CItemManager::LoadItemTable: Zakoñczono ³adowanie %s", c_szFileName);
