...
PyObject* chrmgrReloadGuildMarkImage(PyObject* poSelf, PyObject* poArgs)
{
	int markIndex;
	if (!PyTuple_GetInteger(poArgs, 0, &markIndex))
		return Py_BadArgument();

	CGuildMarkManager::Instance().ReloadGuildMarkImage(markIndex);
