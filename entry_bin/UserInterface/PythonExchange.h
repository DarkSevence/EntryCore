...
public:
	...
	void SetPlayerSelfName(std::string_view name);
	void SetPlayerTargetName(std::string_view name);

	std::string_view GetPlayerSelfName() const;
	std::string_view GetPlayerTargetName() const;

	void SetLevelToTarget(DWORD level);
