...
class CPythonPlayer : public CSingleton<CPythonPlayer>, public IAbstractPlayer
{
	...
	public:
		...
		void	DisableToggleActiveSkills(DWORD dwSlotIndex);
	...
	public:
		...
		void IsOpenKeySettingWindow(BOOL bSet) 
		{ 
			m_isOpenKeySettingWindow = bSet; 
		};

		void KeySetting(int iKey, int iKeyFunction) 
		{
			m_keySettingMap[iKey] = iKeyFunction; 
		}

		void KeySettingClear()
		{ 
