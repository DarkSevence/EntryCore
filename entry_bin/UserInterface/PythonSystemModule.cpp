...
static void RefreshMobInfoForAllCharacters() 
{
...
PyObject* systemSetShowMobAIFlag(PyObject* poSelf, PyObject* poArgs)
{
	...
	RefreshMobInfoForAllCharacters();
...
static PyObject* systemSetCameraMode(PyObject* poSelf, PyObject* poArgs)
{
	uint8_t bMode;
...
static PyObject* systemGetCameraMode(PyObject* poSelf, PyObject* poArgs)
{
