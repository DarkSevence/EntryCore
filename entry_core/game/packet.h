...
enum
{
	...
	HEADER_GC_GUILD_MARK_UPDATE = 211,
	...
	HEADER_GG_RELOAD_CRC_LIST = 18,
	HEADER_GG_LOGIN_PING = 19,
	HEADER_GG_CHECK_CLIENT_VERSION = 20,
	HEADER_GG_BLOCK_CHAT = 21,
	HEADER_GG_CHECK_AWAKENESS = 22,
};
...
typedef struct command_exchange
{
	...
	BYTE arg2;
	TItemPos Pos;
	bool isRightClickAutoMoveEnabled;
} TPacketCGExchange;
...
typedef struct packet_add_char
{
	...
	BYTE	bStateFlag;
	uint32_t playerActiveAffects[2];
	DWORD  dwLevel;
...
typedef struct SPacketGCGuildMarkUpdate
{
	BYTE header;
