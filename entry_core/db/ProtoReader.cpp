...
int get_Item_WearFlag_Value(string inputString) 
{
	...
	string arWearrFlag[] = {"WEAR_BODY", "WEAR_HEAD", "WEAR_FOOTS", "WEAR_WRIST", "WEAR_WEAPON", "WEAR_NECK", "WEAR_EAR", "WEAR_UNIQUE", "WEAR_UNIQUE2", 
					"WEAR_ARROW", "WEAR_SHIELD", "WEAR_ABILITY", "WEAR_COSTUME_BODY", "WEAR_COSTUME_HAIR", "WEAR_COSTUME_MOUNT", "WEAR_RING1", "WEAR_RING2", "WEAR_BELT"};
