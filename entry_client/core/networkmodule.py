...
class MainStream(object):
	...
	def Disconnect(self):
		"""
		This method is responsible for disconnecting from the server.
		It calls the underlying C++ network disconnect function.
		"""
		net.Disconnect()  # This is assumed to be the function exposed from C++ that handles the disconnection.
