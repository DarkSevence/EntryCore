	...
	def __LoadWindow(self):
		...
		try:
			...
			for i in xrange(item.BELT_INVENTORY_SLOT_COUNT):
				...
				wndBeltInventorySlot.SetCoverButton(slotNumber,	"d:/ymir work/ui/game/quest/slot_base.sub",\
												"d:/ymir work/ui/game/quest/slot_base.sub",\
												"d:/ymir work/ui/game/quest/slot_base.sub",\
...
class InventoryWindow(ui.ScriptWindow):
	...
	def __LoadWindow(self):
		...
		for i in xrange(player.INVENTORY_PAGE_COUNT):
			self.inventoryTab[i].SetEvent(partial(self.SetInventoryPage, i))
